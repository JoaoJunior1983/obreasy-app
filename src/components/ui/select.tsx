...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-fit items-center justify-between gap-2 rounded-md border bg-transparent px-3 py-2 text-sm whitespace-nowrap shadow-xs transition-all outline-none",
        ...
        "[&_svg:not([class*='text-'])]:text-foreground/70",
        className
      )}
      {...props}
    >
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "data-[state=checked]:bg-accent/80 data-[state=checked]:text-accent-foreground data-[state=checked]:font-medium",
